...
class SiteSettingController extends BaseController
{
    ...
    public function show()
    {
        // dd(1);
        try {
            $data = SiteSetting::select('id', 'razorpay_key_id', 'platform_fee_value', 'cancellation_charges', 'company_name', 'logo', 'address', 'phone', 'email', 'about_us', 'terms_conditions', 'privacy_policy', 'refund_policy', 'support_email', 'support_phone', 'facebook_url', 'instagram_url', 'twitter_url', 'linkedin_url', 'youtube_url', 'whatsapp_number', 'telegram_url', 'pinterest_url', 'tiktok_url', 'snapchat_url', 'threads_url')->first();
            if (is_null($data)) {
